...
public class TeacherController {
    ...
    public ServiceQueryResult<Teacher> getData() {
        ...
        return CollectionUtils.isNotEmpty(result) ? ServiceQueryResult.asSuccess(result) : ServiceQueryResult.asFail("暂无数据");
    }

    @ApiOperation("获取教师信息")
    @GetMapping("/getInfo/{teacherId}")
    public ServiceResult<Teacher> getTeacherInfo(@PathVariable String teacherId) {
